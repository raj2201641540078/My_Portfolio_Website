...
export default function Hero() {
  const words = [
    ...
    "Proficient In DSA and Algorithms Design",
    "Learning MERN Stack, PostgreSQL, & Web3",
...
const profile = {
    name: 'Raj Singh',
    title: 'Software Developer | AI & Generative AI Enthusiast | Problem Solver',
    skills: [
        'C++', 'Java', 'C','JavaScript', 'HTML', 'CSS',
        'React', 'NodeJS', 'ExpressJS', 'Spring', 'Spring Boot',
        'SQL','MongoDB', 'PostgreSQL','RESTful APIs', 'Git', 
        'Github','Data Structures', 'Algorithms','Systems Design',
        'Problem Solving', 'OOP', 'DBMS', 'OS'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    yearsOfExperience: ForeverFreshman., 
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
            this.skills.length >= Infinite &&
            this.yearsOfExperience >= "__"
        );
    }
};
  `);
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                "⚙️ Forging next-gen tech with Java, JavaScript & System Design 🚀 
              ...
              <div className="hidden lg:block absolute right-10 top-20 animate-float">
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;Robust Code
                </div>
              </div>
