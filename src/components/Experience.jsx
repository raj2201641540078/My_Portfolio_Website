  ...
  const experiences = [
    {
      ...
      period: "2026 - Present",
      description:
        "Selected as a Frontend Developer Intern at WhatBytes, contributing to building scalable user interfaces and innovative web products using modern frontend technologies.",
    },
    {
      icon: Layers,
        ...
        <div className="relative container mx-auto px-6 mt-10">
          ...
          <div className="flex flex-col items-center space-y-8 mb-20">
            ...
            <p className="text-lg md:text-xl text-gray-400 font-medium tracking-wide text-center max-w-2xl">
              "Explore my journey through innovative projects and impactful experiences that have shaped my skills and passion for technology."
            </p>
          </div>
