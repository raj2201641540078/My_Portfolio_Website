  ...
  const skillCategories = [
    {
      ...
      color: "text-blue-400",
      skills: [
        { name: "Java", icon: <FaJava className="w-4 h-4 text-[#61DAFB]" /> },
        // {
        //   name: "Next.js",
        ...
        {
          name: "C++",
          icon: <SiCplusplus className="w-4 h-4 text-[#3178C6]" />,
        },
        {
          name: "C",
          icon: <SiC className="w-4 h-4 text-[#38B2AC]" />,
        },
        {
          name: "Python",
        ...
        {
          name: "Javascript",
          icon: <SiJavascript className="w-4 h-4 text-[#1572B6]" />,
        },
        {
          name: "SQL",
          icon: <BsDatabase className="w-4 h-4 text-[#3776AB]" />,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "ExpressJS",
          icon: <SiExpress className="w-4 h-4 text-[#3178C6]" />,
        },
        {
          name: "FastAPI",
          icon: <FaPython className="w-4 h-4 text-[#3776AB]" />,
